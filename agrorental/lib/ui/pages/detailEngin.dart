          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Align(
                  child: Padding(
                      padding: EdgeInsets.symmetric(horizontal: 15.0),
                      child: Row(children: [Text("Location par jour : "+prix.toString()+" FCFA",
                        style: TextStyle(
                          fontSize: 15,
                          color: Colors.black,
                        ),
            ...
            Column(
              children: [
                ...
                SizedBox(height: 20,),
                Row(mainAxisAlignment: MainAxisAlignment.start,children: [SizedBox(width: 10,),Text("Nos autres Engins",style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),),],),
                Container(
                  height: MediaQuery.of(context).size.height/3,
                      ...
                      ElevatedButton(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(" Louer ",style: TextStyle(color: Colors.white,fontSize: 15,))
                            ],
                          )
                      ),
                    ],
